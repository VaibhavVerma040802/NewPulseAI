    ...
    <div className="min-h-screen bg-[#0a101a] flex items-center justify-center p-5 relative font-sans">
      ...
      <div className="w-full max-w-[380px] bg-[#141e2e] border border-[#1e2d45] rounded-[16px] p-8 relative shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)]">
        <div className="text-center mb-6">
          ...
          <h1 className="font-serif text-[24px] font-bold text-[#f1f5f9] m-0 mb-1.5">Welcome back</h1>
          <p className="text-[#64748b] text-[13px] m-0">Enter your details to access your dashboard.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-[#94a3b8] text-[12px] font-medium">Password</label>
              <span className="text-[#3b82f6] text-[11px] cursor-pointer font-medium hover:underline">Forgot?</span>
            </div>
            <input 
              type="password"
              required
